...
{
    public class AddCertificateTopicValidator : AbstractValidator<AddCertificateTopicDto>
    {
        private readonly IUnitOfWork unitOfWork;
        private readonly ICertificateTopicService certificateTopicService;
        private readonly IQuestionService questionService;

        public AddCertificateTopicValidator(IUnitOfWork unitOfWork, ICertificateTopicService certificateTopicService, IQuestionService questionService)
        {
